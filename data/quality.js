var DATA_QUALITY={
  "schemaVersion": 1,
  "checkedAt": "2026-09-23T17:06:38+00:00",
  "asOf": "2026-09-24",
  "status": "unverified",
  "summary": {
    "errors": 0,
  ...
  "datasets": [
    {
      ...
      "issues": [
        {
          "code": "fee_source_date",
          "severity": "unverified",
          "message": "费率缺生效日期，购买前需以基金正式文件与交易渠道为准",
          "affected": [
            "050025",
            "161125",
            "018064",
    ...
    },
    {
      ...
      "issues": [
        {
          "code": "fx_risk_incomplete",
          "severity": "warning",
          "message": "完整人民币日风险缺少实际汇率（2025-04-21）；未沿用美元风险或填补汇率",
          "affected": [
            "标普500指数",
            "SPY",
            "SSO",
    ...
    },
    {
      ...
      "issues": [
        {
          "code": "domestic_basis_unverified",
          "severity": "unverified",
          "message": "扩展研究池的历史快照尚未逐只重算，候选资格不代表收益数据已核验",
          "affected": [
            "001437",
            "519196",
            "001323",
        ...
        },
        {
          ...
          "severity": "warning",
          "message": "82只扩展基金的净值缺日期或超过10日；规则重生成不代表净值已更新",
          "affected": [
            "001437",
            "519196",
            "001323",
        ...
        {
          "code": "research_scale_date_unverified",
          "severity": "unverified",
          "message": "1268只扩展基金的规模缺独立观察日期；不能作为当前规模判断",
          "affected": [
            "004685",
            "001437",
            "519196",
